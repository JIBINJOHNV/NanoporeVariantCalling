...
PrioritisedDf=PrioritisedDf[list(PrioritisedDf.iloc[:,:-15].columns)+['#chrom', 'start', 'end',
        'TotalRegion','Sequenced_Library',
        'Sample Name','Sample ID','Gene','FragmentsinWHichMutationObserved',
        'No_of_Fragments','Sequenced_Fragemnts_Name_count','Sequenced_Fragemnts_Name',
        'Amplicon_with_lt<95%_20Xcoverage', 'Amplicon_with_Mt>=95%_20Xcoverage']]
...
NoPrioritisedVariants_df=NoPrioritisedVariants_df[['Sample ID', 'Sample Name', 'Gene','AttentionRequire_OrNot',
